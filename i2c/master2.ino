...
void loop()
  ...
  RemoteSensorData_t sensor1; 
          ...
          if( getData( &sensor1 ))
            ...
            Serial.print("    ");
            Serial.print("\t");
            Serial.print(sensor1.myUmidade);
            Serial.print("    ");
            Serial.print("\t");
            Serial.print(sensor1.myCorrente);
            Serial.println();
            delay(500);            
                                      }
          else
...
bool getData(RemoteSensorData_t* sensorInfo)
{
  ...
  float2bytes_t b2fUmidade;
  float2bytes_t b2fCorrente;
  ...
  if(gotI2CPacket)
  {
    ...
    b2fUmidade.b[0] = i2CData[8];
    b2fUmidade.b[1] = i2CData[9];
    b2fUmidade.b[2] = i2CData[10];
    b2fUmidade.b[3] = i2CData[11];
    sensorInfo->myUmidade = b2fUmidade.f;
    
    b2fCorrente.b[0] = i2CData[12];
    b2fCorrente.b[1] = i2CData[13];
    b2fCorrente.b[2] = i2CData[14];
    b2fCorrente.b[3] = i2CData[15];
    sensorInfo->myCorrente = b2fCorrente.f;
    return true;
  }  // end got packet
